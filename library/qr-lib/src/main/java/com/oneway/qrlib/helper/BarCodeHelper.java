package com.oneway.qrlib.helper;
...
public class BarCodeHelper {
     ...
     *
     * @param text 样式字符串文本
     * @return {@link BarCodeHelper.Builder}
     */
    public static BarCodeHelper.Builder builder(@NonNull CharSequence text) {
        return new BarCodeHelper.Builder(text);
    }
    ...
    public static class Builder {
        ...
        public Bitmap into(ImageView imageView) {
            Bitmap bitmap = BarCodeHelper.createBarCode(content, codeWidth, codeHeight, backgroundColor, codeColor);
            if (imageView != null) {
