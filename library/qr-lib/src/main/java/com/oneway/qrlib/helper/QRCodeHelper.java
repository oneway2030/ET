...
public class QRCodeHelper {
     ...
     *
     * @param text 样式字符串文本
     * @return {@link QRCodeHelper.Builder}
     */
    public static QRCodeHelper.Builder builder(@NonNull CharSequence text) {
        return new QRCodeHelper.Builder(text);
    }
    ...
    public static class Builder {
        ...
        public Bitmap into(ImageView imageView) {
            Bitmap bitmap = QRCodeHelper.creatQRCode(content, codeSide, codeSide, backgroundColor, codeColor);
            if (imageView != null) {
