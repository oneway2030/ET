...
public class CrashUtils {
    ...
    static {
        try {
            PackageInfo pi = ToolConfig.getContext().getPackageManager().getPackageInfo(ToolConfig.getContext().getPackageName(), 0);
            if (pi != null) {
    ...
    public static void init(final String crashDir) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && ToolConfig.getContext().getExternalCacheDir() != null)
            defaultDir = ToolConfig.getContext().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = ToolConfig.getContext().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
