...
public class PhoneUtils {
    ...
    public static boolean isPhone() {
        TelephonyManager tm = (TelephonyManager) ToolConfig.getContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) ToolConfig.getContext()
    ...
    public static void dial(final String phoneNumber) {
        ToolConfig.getContext().startActivity(IntentUtils.getDialIntent(phoneNumber));
    }
    ...
    public static void call(final String phoneNumber) {
        ToolConfig.getContext().startActivity(IntentUtils.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(final String phoneNumber, final String content) {
        ToolConfig.getContext().startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content));
    }
    ...
    public static void sendSmsSilent(final String phoneNumber, final String content) {
        if (EmptyUtils.isEmpty(content)) return;
        PendingIntent sentIntent = PendingIntent.getBroadcast(ToolConfig.getContext(), 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = ToolConfig.getContext().getContentResolver();
        ...
        try {
            ...
            if (cursor != null) {
                while (cursor.moveToNext()) {
                    ...
                    // 判断 contact_id 是否为空
                    if (EmptyUtils.isNotEmpty(contact_id)) {//null   ""
