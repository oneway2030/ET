...
public class AppUtils {
    ...
    public static boolean isInstallApp(final String action, final String category) {
        ...
        PackageManager pm = ToolConfig.getContext().getPackageManager();
    ...
    public static void installApp(final File file, final String authority) {
        ...
        ToolConfig.getContext().startActivity(IntentUtils.getInstallAppIntent(file, authority, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        ToolConfig.getContext().startActivity(IntentUtils.getUninstallAppIntent(packageName, true));
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        ToolConfig.getContext().startActivity(IntentUtils.getLaunchAppIntent(packageName));
    }
    ...
    public static String getAppPackageName() {
        return ToolConfig.getContext().getPackageName();
    }
    ...
    public static void getAppDetailsSettings() {
        getAppDetailsSettings(ToolConfig.getContext().getPackageName());
    }
    ...
    public static void getAppDetailsSettings(final String packageName) {
        if (isSpace(packageName)) return;
        ToolConfig.getContext().startActivity(IntentUtils.getAppDetailsSettingsIntent(packageName));
    }
    ...
    public static String getAppName() {
        return getAppName(ToolConfig.getContext().getPackageName());
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(ToolConfig.getContext().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(ToolConfig.getContext().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(ToolConfig.getContext().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(ToolConfig.getContext().getPackageName());
    }
    ...
    public static boolean isSystemApp() {
        return isSystemApp(ToolConfig.getContext().getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(ToolConfig.getContext().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(ToolConfig.getContext().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(ToolConfig.getContext().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ActivityManager manager =
                (ActivityManager) ToolConfig.getContext().getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningAppProcessInfo> info = manager.getRunningAppProcesses();
        if (info == null || info.size() == 0) return false;
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(ToolConfig.getContext().getPackageName());
            }
        }
        return false;
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(ToolConfig.getContext().getPackageName());
    }
