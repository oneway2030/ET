...
public class CleanUtils {
    ...
    public static boolean cleanInternalCache() {
        return deleteFilesInDir(ToolConfig.getContext().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return deleteFilesInDir(ToolConfig.getContext().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return deleteFilesInDir(ToolConfig.getContext().getFilesDir().getParent() + File.separator + "databases");
    }
    ...
    public static boolean cleanInternalDbByName(final String dbName) {
        return ToolConfig.getContext().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSP() {
        return deleteFilesInDir(ToolConfig.getContext().getFilesDir().getParent() + File.separator + "shared_prefs");
    }
    ...
    public static boolean cleanExternalCache() {
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) && deleteFilesInDir(ToolConfig.getContext().getExternalCacheDir());
    }
