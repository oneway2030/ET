...
public class ServiceUtils {
    ...
    public static Set getAllRunningService() {
        ActivityManager activityManager = (ActivityManager) ToolConfig.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static void startService(final Class<?> cls) {
        Intent intent = new Intent(ToolConfig.getContext(), cls);
        ToolConfig.getContext().startService(intent);
    }
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(ToolConfig.getContext(), cls);
        return ToolConfig.getContext().stopService(intent);
    }
    ...
    public static void bindService(final Class<?> cls, final ServiceConnection conn, final int flags) {
        Intent intent = new Intent(ToolConfig.getContext(), cls);
        ToolConfig.getContext().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        ToolConfig.getContext().unbindService(conn);
    }
