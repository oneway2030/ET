...
public class AppCleanUtil {
    ...
    public static void cleanInternalCache(Context context) {
        FileUtils.deleteFilesInDir(context.getCacheDir());
        LogUtil.i("AppCleanMgr->>cleanInternalCache", "清除本应用内部缓存(/data/data/" + context.getPackageName() + "/cache)");
    }
    ...
    public static void cleanExternalCache(Context context) {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            ...
            LogUtil.i("AppCleanMgr->>cleanExternalCache", "清除本应用外部缓存数据(/mnt/sdcard/android/data/" + context.getPackageName() + "/cache)");
        }
    }
    ...
    public static void cleanDatabases(Context context) {
        FileUtils.deleteFilesInDir(new File("/data/data/" + context.getPackageName() + "/databases"));
    ...
    public static void cleanSharedPreference(Context context) {
        FileUtils.deleteFilesInDir(new File("/data/data/" + context.getPackageName() + "/shared_prefs"));
    ...
    public static void cleanFiles(Context context) {
        FileUtils.deleteFilesInDir(context.getFilesDir());
        LogUtil.i("AppCleanMgr->>cleanFiles", "清除data/data/" + context.getPackageName() + "/files下的内容信息");
    }
    ...
    public static String getAppClearSize(Context context) {
        ...
        clearSize += FileUtils.getFileLength(FileUtils.getFileByPath(path));
