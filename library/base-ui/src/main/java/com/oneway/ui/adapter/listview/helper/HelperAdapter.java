...
import com.oneway.ui.adapter.listview.BaseAdapter;
import com.oneway.ui.adapter.listview.BaseViewHolder;
...
public abstract class HelperAdapter<T> extends BaseAdapter<T> implements DataHelper<T> {
    public HelperAdapter(List data, int... layoutIds) {
        super(data, layoutIds);
    }

    public HelperAdapter(List data) {
        super(data);
    }

    public HelperAdapter(int... layoutIds) {
        super(layoutIds);
    }
